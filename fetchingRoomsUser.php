...
function showUser(str) {
    if (str == "") {
        ...
        xmlhttp.open("GET","viewRoomsUser.php?q="+str,true);
        xmlhttp.send();
    }
}
</script>
...
<br /> <br />
  ...
  <br />                          
      <br />
      <h1 style="margin-left: 310px;"> <u> Rooms in the database </u> </h1>
        <form>
...
<br /> <br />
<div id="result_set_commission_details_user">
<div id="txtHint" style="margin-left:60px;"><b>Room data will be displayed here ...</b>
</div> <!-- close txtHint-->
</div> <!-- close result_set_user_details-->  	 	               
	</div> <!--close site_content--> 
  <br />
  <input style="margin-left:380px;" type="submit" value="Print PDF" onclick="window.print()" />
