...
//Sql command that checks whether the client booking really exists in the user_details table...
...
<head>
 ...
 <link rel="stylesheet"type="text/css" href="../css/ui-lightness/jquery-ui-1.8.21.custom.css" />
  ...
  <script language="javascript" type="text/javascript" src="../js/standardSingle.js"> </script>
...
$(function() {
    $( "#checkInDate" ).datepicker({
        ...
        beforeShow: function(){
            ...
            // sets "theDate" 22 days ahead of the first day
...
<br /> <br />
  <div id="main">
    ...
    <div class="button_small" style="margin-left:170px;">
          <a href="standardSingleRoomDetail.php">Back</a>
        </div><!--close button_small-->  
  <div id="site_content">   
    <br />   
    <h1 style="margin-left:250px;"> <u> Standard Single Room Booking Form </u> </h1>
    <br />
           ...
           <div id="bookingContainer">
                ...
                <label> Type Of Room:</label>
                     <select name="room">
                <option value="Standard Single Room" selected > Standard Single Room </option>
                     </select>
                </div> <br /> <br />
                 <div id="form-group">
