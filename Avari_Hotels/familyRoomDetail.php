...
<br /> <br />
  <div id="main">
	...
	<div id="site_content">	
<br />
    <h1 style="margin-left:370px;text-decoration:none;color:maroon;"> <u> Family Room </u> </h1>
    <br />
    <div class="content_container_ad">
<img style="border-radius:25px;margin-left:0px;height:350px;width:400px;" src="../images/imageB.jpeg" alt="Third Image">
    ...
    <?php
include 'base.php';
$sql="SELECT `room_id`,`hotel_name`,`room_type`,`room_number` FROM  `room_details` where `hotel_name`='Avari Hotels' and room_type='Family Room' order by `room_number` asc ";
...
<div class="content_container_ad">
    ...
    <br /> 
        <div class="button_small">
          <a href="familyRoomForm.php">Book Now</a>
