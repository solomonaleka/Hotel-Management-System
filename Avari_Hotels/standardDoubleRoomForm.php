...
<head>
 ...
 <link rel="stylesheet"type="text/css" href="../css/ui-lightness/jquery-ui-1.8.21.custom.css" />
  ...
  <script language="javascript" type="text/javascript" src="../js/standardDouble.js"> </script>
...
<br /> <br />
  <div id="main">
    ...
    <div class="button_small" style="margin-left:170px;">
          <a href="standardDoubleRoomDetail.php">Back</a>
        </div><!--close button_small-->  
  <div id="site_content">   
    <br />   
    <h1 style="margin-left:240px;"> <u> Standard Double Room Booking Form </u> </h1>
    <br />
           ...
           <div id="bookingContainer">
                ...
                <label> Type Of Room:</label>
                     <select name="room">
                <option value="Standard double room" selected > Standard Double Room </option>
                     </select>
                </div> <br /> <br />
                 <div id="form-group">
