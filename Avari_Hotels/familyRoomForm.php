...
<head>
 ...
 <link rel="stylesheet"type="text/css" href="../css/ui-lightness/jquery-ui-1.8.21.custom.css" />
  ...
  <script language="javascript" type="text/javascript" src="../js/familyRoom.js"> </script>
...
<br /> <br />
  <div id="main">
    ...
    <div class="button_small" style="margin-left:170px;">
          <a href="familyRoomDetail.php">Back</a>
        </div><!--close button_small-->  
  <div id="site_content">   
    <br />   
    <h1 style="margin-left:285px;"> <u> Family Room Booking Form </u> </h1>
    <br />
