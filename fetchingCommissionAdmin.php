...
function showUser(str) {
    if (str == "") {
        ...
        xmlhttp.open("GET","viewCommissionAdmin.php?q="+str,true);
        xmlhttp.send();
    }
}
</script>
...
<br /> <br />
  ...
  <br />                          
      <br />
      <h1 style="margin-left: 310px;"> <u> Charges in the database </u> </h1>
        <form>
...
<br /> <br />
<div id="result_set_commission_details_admin">
<div id="txtHint" style="margin-left:60px;"><b> Commission data will be displayed here ...</b>
</div> <!-- close txtHint-->
