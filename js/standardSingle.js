      function validate() { 
         ...
         {
            alert( "Please provide Hotel Name with letters only!!" );
         ...
         if(document.myForm.hotelname.value=="Avari Hotels") {
          if(document.myForm.amount.value!=900) {
            alert("The Amount Per Room for Avari Hotels is 900!!");
            return false;
          }
         }
