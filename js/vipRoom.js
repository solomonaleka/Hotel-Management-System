      function validate() { 
         ...
         {
            alert( "Please provide your Seconds Name with letters only!!" );
         ...
         if(document.myForm.hotelname.value=="Avari Hotels") {
          if(document.myForm.amount.value!=1600) {
            alert("The Amount Per Room for Avari Hotels is 1600!!");
            return false;
          }
         }
