      function validate() { 
         ...
         if(document.myForm.hotelname.value=="Avari Hotels") {
          if(document.myForm.amount.value!=1000) {
            alert("The Amount Per Room for Avari Hotels is 1000!!");
            return false;
          }
         }
